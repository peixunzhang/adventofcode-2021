...
object Hello extends App {
  def launchAll(target: Target): Int= {
    val vxMin = 0
    ...
    probes.flatMap(_.launch(target)).size
  }

  println(launchAll(Target(282, 314, -45, -80)))
}
...
final case class Target(xLeft: Int, xRight: Int, yUp: Int, yDown: Int) {
